...
var ProductsViewItems = function(cursor) {
	...
	if(!searchString || searchString == "") {
		...
		var searchFields = ["name", "note", "url", "price"];
...
var ProductsViewExport = function(cursor, fileType) {
	...
	var exportFields = ["name", "note", "url", "price"];
...
Template.ProductsViewTableItems.events({
	"click td": function(e, t) {
		...
		Router.go("products.details", {productId: this._id});
		return false;
	},
	...
	"click #edit-button": function(e, t) {
		e.preventDefault();
		Router.go("products.edit", {productId: this._id});
		return false;
	}
});
